...
class TeamMetricsCalculator:
    ...
    def __init__(self, parsed_items: List[Dict], done_states: Set[str], active_states: Set[str], config_manager=None):
    ...
    def calculate_team_metrics(
        ...
        # Apply filtering
        selected_members = self._apply_workstream_filtering(workstreams, selected_members)
    ...
    def _group_items_by_assignee(self, selected_members: Optional[List[str]]) -> Dict[str, List[Dict]]:
    ...
    def _calculate_individual_member_metrics(
        ...
        avg_lead_time, velocity_items = self._calculate_lead_time_and_velocity(closed_items)
    ...
    def _calculate_lead_time_and_velocity(self, closed_items: List[Dict]) -> tuple[float, List[Dict]]:
