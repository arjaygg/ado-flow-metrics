...
def generate_mock_azure_devops_data():
    ...
    team_members = [
        "Ian Abellana", "Glizzel Ann Artates", "Joshua Asi", 
        "Prince Joedymar Jud Barro", "Jude Marco Bayot", "Ian Belmonte",
        "Patrick Oniel Bernardo", "Erwin Biglang-awa", "Antonio Florencio Bisquera",
        "Janiel Apollo Bodiongan", "Ronald Bucayan", "James Aaron Constantino",
        "Ariel Dimapilis", "Nymar Fernandez", "Jay Mark Lagmay",
        "Nenissa Malibago", "Christian Nailat", "Christopher Reyes",
        "Christopher Jan Riños", "Joebert Rosales", "Rex Nino Santos",
        "Diego Saylon", "Myra Selda", "Joyce Diane Sison",
        "Cleo Erika Soriano", "Rio Alyssa Venturina"
    ]
    ...
    for i in range(200):  # Generate 200 work items
        ...
        work_item = {
            ...
            "assigned_to": random.choice(team_members),
            "current_state": state_transitions[-1]["state"] if state_transitions else "New",
            ...
            "tags": random.sample(["frontend", "backend", "database", "api", "ui", "testing"], 
                                random.randint(1, 3))
        }
